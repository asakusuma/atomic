...
((typeof define == 'function' && define.amd) ? define : Atomic)('components/select', ['Atomic/Component'], function(Component) {
  ...
  return Atomic.Component({
    ...
    elements: {
      viewport: '(autogenerated) will contain the viewport- a container hosting the select choices',
      item: '(autogenerated, empty) assigned to every item in the select box that the user can choose',
      replaced: '(autogenerated) the select list that was replaced'
    },
    ...
    */
    syncList: function() {
      ...
      node.find('option').each(function() {
        ...
        li.text($(this).val());
        li.addClass(that.BEM(that.elements.item));
        ul.append(li);
      });
    ...
    */
    syncListSelected: function() {
      ...
      ul.find('li').removeClass(this.BEM(that.elements.item, 'selected'));

      this.node.find('option').each(function() {
        option = $(this);
        if (option.is(':selected')) {
          $(ul.find('li')[option.index()]).addClass(that.BEM(that.elements.item, 'selected'));
        }
      });
    },
    /**
    ...
    */
    ...
    _build: function() {
      ...
      viewport.addClass(this.BEM(this.elements.viewport));
      
      this.assign(this.elements.viewport, viewport.get(0));
      this.assign(this.elements.replaced, node.get(0));
      ...
      node.removeClass(this.BEM(this.elements.root));
      node.addClass(this.BEM(this.elements.replaced));
